...
The canonical public listing source of truth is [`PUBLIC_LISTING.md`](https://github.com/oaslananka/kicad-mcp-pro/blob/main/PUBLIC_LISTING.md) at the repository root.
